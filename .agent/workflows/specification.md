...
4. **Initialization**: If `.design/INDEX.md` or `.design/RULES.md` are missing, **STOP** and execute the *Initialization Script* for the user's OS.
5. **Content Creation**:
...
> `INDEX.md` and `RULES.md` are generated by the **Initialization Scripts** below.
> Their full content is defined there — refer to the scripts as the authoritative template source.
